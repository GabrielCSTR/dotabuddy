...
<template>
  ...
  >
    ...
    <p
      class="bg-gradient-to-r font-semibold squada-one-regular mt-2 text-center text-lg from-amber-800 via-amber-700 to-amber-600 inline-block text-transparent bg-clip-text"
